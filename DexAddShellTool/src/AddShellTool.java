...
public class AddShellTool {
	...
	public static void main(String[] args) {
		...
		try {
			File payloadSrcFile = new File("force/ForceApkObj.apk");   // 我们要加壳的apk文件
			System.out.println("apk size:"+payloadSrcFile.length());
			File unShellDexFile = new File("force/ForceApkObj.dex");	// 我们的程序生成的dex文件
